...
public class StorageService {
    ...
    BlobServiceClient blobServiceClient = new BlobServiceClientBuilder().connectionString("DefaultEndpointsProtocol=https;AccountName=bryanlibarter;AccountKey=sGRz1213Ma1o5YjW9ePfOMnNij2yyZVhH2rzhEugrTAgK2G61VO5TmOMp/bCsYpinzggzVMfDXOS+AStax0R3Q==;EndpointSuffix=core.windows.net").buildClient();
